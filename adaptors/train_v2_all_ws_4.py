...
parser.add_argument('--outf', default='checkpoints/all_ws_4/dinov2_s14', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dinov2_vits14_reg', help='model name')
# parser.add_argument('--outf', default='checkpoints/all_ws_4/dinov2_s14_reg', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dinov2_vitb14', help='model name')
# parser.add_argument('--outf', default='checkpoints/all_ws_4/dinov2_b14', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dinov2_vitb14_reg', help='model name')
# parser.add_argument('--outf', default='checkpoints/all_ws_4/dinov2_b14_reg', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dinov2_vitl14', help='model name')
# parser.add_argument('--outf', default='checkpoints/all_ws_4/dinov2_l14', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dinov2_vitl14_reg', help='model name')
# parser.add_argument('--outf', default='checkpoints/all_ws_4/dinov2_l14_reg', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dinov2_vitg14', help='model name')
# parser.add_argument('--outf', default='checkpoints/all_ws_4/dinov2_g14', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dinov2_vitg14_reg', help='model name')
# parser.add_argument('--outf', default='checkpoints/all_ws_4/dinov2_g14_reg', help='folder to output model checkpoints')
