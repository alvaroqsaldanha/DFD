...
from linear import LinearClassifierDropoutWSAllv2
...
parser.add_argument('--outf', default='checkpoints/all_dropout_ws_4/dinov2_b14', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dinov2_vitl14_reg', help='model name')
# parser.add_argument('--dropout', type=float, default=0.4, help='dropout rate')
# parser.add_argument('--outf', default='checkpoints/all_dropout_ws_4/dinov2_l14_reg', help='folder to output model checkpoints')
...
if __name__ == "__main__":
    ...
    model = LinearClassifierDropoutWSAllv2(dim=opt.dim, num_blocks=opt.blocks, dropout=opt.dropout)
    ...
    for epoch in range(opt.resume+1, opt.niter+1):
        ...
        for img_file, img_data, labels_data in tqdm(dataloader_train):
            ...
            classes = model(output, is_training=True)
