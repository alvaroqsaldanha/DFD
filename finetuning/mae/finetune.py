...
from models import ForensicsTransformer
...
parser.add_argument('--num_unfrozen_blocks', type=int, default=2, help='number of last blocks to train')
...
if __name__ == "__main__":
    ...
    model = ForensicsTransformer(num_unfrozen_blocks=opt.num_unfrozen_blocks)
