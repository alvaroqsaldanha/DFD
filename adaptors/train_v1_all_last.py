...
parser.add_argument('--dim', type=int, default=75648, help='output dim') # 197 * 384
# parser.add_argument('--dim', type=int, default=301440, help='output dim') # 785 * 384
# parser.add_argument('--dim', type=int, default=151296, help='output dim') # 197 * 768
# parser.add_argument('--dim', type=int, default=602880, help='output dim') # 785 * 768

parser.add_argument('--model', default='dino_vits16', help='model name')
parser.add_argument('--outf', default='checkpoints/all_1/dinov1_s16', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dino_vits8', help='model name')
# parser.add_argument('--outf', default='checkpoints/all_1/dinov1_s8', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dino_vitb16', help='model name')
# parser.add_argument('--outf', default='checkpoints/all_1/dinov1_b16', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dino_vitb8', help='model name')
# parser.add_argument('--outf', default='checkpoints/all_1/dinov1_b8', help='folder to output model checkpoints')
...
if __name__ == "__main__":
    ...
    for epoch in range(opt.resume+1, opt.niter+1):
        ...
        for img_file, img_data, labels_data in tqdm(dataloader_train):
            ...
            with torch.no_grad():
                output = dino.get_intermediate_layers(img_data, 1)
                output = output[0].view(output[0].shape[0], -1)
