...
parser.add_argument('--outf', default='checkpoints/cls_ws_4/dinov1_s8', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dino_vits16', help='model name')
# parser.add_argument('--outf', default='checkpoints/cls_ws_4/dinov1_s16', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dino_vitb8', help='model name')
# parser.add_argument('--outf', default='checkpoints/cls_ws_4/dinov1_b8', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dino_vitb16', help='model name')
# parser.add_argument('--outf', default='checkpoints/cls_ws_4/dinov1_b16', help='folder to output model checkpoints')
