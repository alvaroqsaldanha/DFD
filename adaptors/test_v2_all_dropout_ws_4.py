...
parser.add_argument('--outf', default='checkpoints/all_dropout_ws_4/dinov2_b14', help='folder to output images and model checkpoints')
parser.add_argument('--id', type=int, help='checkpoint ID')

# parser.add_argument('--model', default='dinov2_vitl14_reg', help='model name')
# parser.add_argument('--dropout', type=float, default=0.4, help='dropout rate')
# parser.add_argument('--outf', default='checkpoints/all_dropout_ws_4/dinov2_l14_reg', help='folder to output images and model checkpoints')
# parser.add_argument('--id', type=int, help='checkpoint ID')
