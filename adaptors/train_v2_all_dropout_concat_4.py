...
from linear import LinearClassifierConcatAllv2
...
parser.add_argument('--outf', default='checkpoints/all_concat_4/dinov2_b14', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dinov2_vitb14', help='model name')
# parser.add_argument('--dropout', type=float, default=0.4, help='dropout rate')
# parser.add_argument('--outf', default='checkpoints/all_dropout_concat_4/dinov2_b14', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dinov2_vitl14_reg', help='model name')
# parser.add_argument('--dropout', type=float, default=0.0, help='dropout rate')
# parser.add_argument('--outf', default='checkpoints/all_concat_4/dinov2_l14_reg', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dinov2_vitl14_reg', help='model name')
# parser.add_argument('--dropout', type=float, default=0.4, help='dropout rate')
# parser.add_argument('--outf', default='checkpoints/all_dropout_concat_4/dinov2_l14_reg', help='folder to output model checkpoints')

# parser.add_argument('--model', default='dinov2_vitl14', help='model name')
# parser.add_argument('--dropout', type=float, default=0.4, help='dropout rate')
# parser.add_argument('--outf', default='checkpoints/all_dropout_concat_4/dinov2_l14', help='folder to output model checkpoints')
...
if __name__ == "__main__":
    ...
    model = LinearClassifierConcatAllv2(dim=opt.dim, num_blocks=opt.blocks, dropout=opt.dropout)
