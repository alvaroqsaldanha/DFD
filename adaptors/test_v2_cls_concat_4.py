...
# parser.add_argument('--dim', type=int, default=4096, help='output dim')
# parser.add_argument('--dim', type=int, default=6144, help='output dim')

parser.add_argument('--model', default='dinov2_vits14', help='model name')
parser.add_argument('--outf', default='checkpoints/cls_concat_4/dinov2_s14', help='folder to output images and model checkpoints')
parser.add_argument('--id', type=int, help='checkpoint ID')

# parser.add_argument('--model', default='dinov2_vits14_reg', help='model name')
# parser.add_argument('--outf', default='checkpoints/cls_concat_4/dinov2_s14_reg', help='folder to output images and model checkpoints')
# parser.add_argument('--id', type=int, help='checkpoint ID')

# parser.add_argument('--model', default='dinov2_vitb14', help='model name')
# parser.add_argument('--outf', default='checkpoints/cls_concat_4/dinov2_b14', help='folder to output images and model checkpoints')
# parser.add_argument('--id', type=int, help='checkpoint ID')

# parser.add_argument('--model', default='dinov2_vitb14_reg', help='model name')
# parser.add_argument('--outf', default='checkpoints/cls_concat_4/dinov2_b14_reg', help='folder to output images and model checkpoints')
# parser.add_argument('--id', type=int, help='checkpoint ID')

# parser.add_argument('--model', default='dinov2_vitl14', help='model name')
# parser.add_argument('--outf', default='checkpoints/cls_concat_4/dinov2_l14', help='folder to output images and model checkpoints')
# parser.add_argument('--id', type=int, help='checkpoint ID')

# parser.add_argument('--model', default='dinov2_vitl14_reg', help='model name')
# parser.add_argument('--outf', default='checkpoints/cls_concat_4/dinov2_l14_reg', help='folder to output images and model checkpoints')
# parser.add_argument('--id', type=int, help='checkpoint ID')

# parser.add_argument('--model', default='dinov2_vitg14', help='model name')
# parser.add_argument('--outf', default='checkpoints/cls_concat_4/dinov2_g14', help='folder to output images and model checkpoints')
# parser.add_argument('--id', type=int, help='checkpoint ID')

# parser.add_argument('--model', default='dinov2_vitg14_reg', help='model name')
# parser.add_argument('--outf', default='checkpoints/cls_concat_4/dinov2_g14_reg', help='folder to output images and model checkpoints')
# parser.add_argument('--id', type=int, help='checkpoint ID')
...
if __name__ == '__main__':
    ...
    for img_file, img_data, labels_data in tqdm(dataloader_test):
        ...
        with torch.no_grad():
            ...
            concat = output[0][1]
            for i in range(opt.blocks - 1):
                concat = torch.cat((concat, output[i+1][1]), dim=-1)
